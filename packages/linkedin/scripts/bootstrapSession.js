...
const fileAdapter_1 = require("../src/sessionManager/fileAdapter");
const sessionManager_1 = require("../src/sessionManager/sessionManager");
const manager_1 = require("../src/browser/manager");
...
async function run() {
    ...
    const adapter = new fileAdapter_1.FileSessionAdapter();
    const manager = new manager_1.BrowserManager({ headless, userAgent });
    const sessionManager = new sessionManager_1.LinkedInSessionManager(adapter, sessionId, {
